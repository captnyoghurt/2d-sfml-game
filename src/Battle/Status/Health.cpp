...
int Health::getPoints() const { return m_points; }

// Return the maximum number of health points
int Health::getMaxPoints() const { return m_maxPoints; }

// Return the actual health bonus
int Health::getBonus() const { return m_bonus; }
...
bool Health::enoughFor(const int &points) { return (m_points >= points); }
