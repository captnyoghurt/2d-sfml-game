...
EffectOnCharacteristic::EffectOnCharacteristic(const int &brut,
                                               const double &ratio) {
  m_brut = brut;
  m_ratio = ratio;
  m_numberOfTurn = 0;
...
double EffectOnCharacteristic::getRatio() const { return m_ratio; }

// Return the brut bonus
int EffectOnCharacteristic::getBrut() const { return m_brut; }

// Return the number of turn stayed
int EffectOnCharacteristic::getNumberOfTurn() const { return m_numberOfTurn; }
