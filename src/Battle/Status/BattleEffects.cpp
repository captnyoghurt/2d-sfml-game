...
BattleEffects::BattleEffects(const int id,
                             const Characteristic::e_characteristics &c,
                             const int &chance, const int &power,
                             const e_EffectsTarget &et, const int &people)
    : m_id(id),
      m_characteristic(c),
      m_chance(chance),
      m_power(power),
...
// Return the id
int BattleEffects::getId() const { return m_id; }
...
// Return the chance
int BattleEffects::getChance() const { return m_chance; }

// Return the power
int BattleEffects::getPower() const { return m_power; }
...
int BattleEffects::getNumberOfPeople() const { return m_numberOfPeople; }
...
int BattleEffects::setCharacteristic(
    const Characteristic::e_characteristics &c) {
