...
class MenuBattleSide : public Menu {
 public:
  enum e_menuBattleSideBarType {
    MENU_BATTLE_ENEMIE,
    MENU_BATTLE_ALLIE,
    MENU_BATTLE_TOTAL
  };
  enum e_menuBattleSideItems {
    NAME,
    HP_TEXT,
    HP_IMAGE,
    MP_TEXT,
    ...
    TP_TEXT,
    TP_IMAGE,
    MENU_BATTLE_ITEM_TOTAL
  };

 public:
  MenuBattleSide(ManageRessources& ress, ManageSurfaces& surf,
 ...
 public:
   ...
   * \return int object.
   */
  int updateBar(int n, MenuBattleSide::e_menuBattleSideItems type, int act,
                int max);
  /**
   ...
   * \return int object.
   */
  int loadWithEnemies(ManageRessources& ress, ManageSurfaces& surf,
                      Enemies& enemies);
  /**
   ...
   * \return int object.
   */
  int loadWithAllies(ManageRessources& ress, ManageSurfaces& surf,
                     TeamBattle& allies);
   ...
   * \return virtual object.
   */
  virtual int load(ManageRessources& ress, ManageSurfaces& surf, const int& x,
                   const int& y, const int& w = -1, const int& h = -1);
  /**
