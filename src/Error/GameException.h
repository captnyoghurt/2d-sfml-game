...
enum e_ExceptionLevel {
  EXCEPTION_SIMPLE_WARNING,
  EXCEPTION_WARNING,
  EXCEPTION_ERROR,
...
class GameException : public std::exception {
 public:
  GameException(const std::string &description, const int &line,
                const std::string &file, const std::string &func,
                e_ExceptionLevel level = EXCEPTION_FATAL_ERROR) throw();
