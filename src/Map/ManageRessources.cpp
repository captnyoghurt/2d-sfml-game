...
ManageRessources::~ManageRessources() { clear(); }

// Return all the fonts
std::list<sf::Font> ManageRessources::getFonts() const { return m_fonts; }

// Return all the images
std::list<sf::Image> ManageRessources::getImages() const { return m_images; }
...
std::list<sf::Font>& ManageRessources::getRealFonts() { return m_fonts; }

// Return all the images with modifying possibilities
std::list<sf::Image>& ManageRessources::getRealImages() { return m_images; }
...
int ManageRessources::deleteSoundBuffer(
    std::list<sf::SoundBuffer>::iterator it) {
