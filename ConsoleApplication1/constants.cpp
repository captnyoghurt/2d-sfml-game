...
int HEALTH_SURFACE_WIDTH = 5;
int HEALTH_SURFACE_HEIGHT = 60;
int HEALTH_TEXT_POSITION_X = 0;
...
int SKILLPOINTS_SURFACE_BEGIN_Y = 0;
int SKILLPOINTS_SURFACE_WIDTH = 5;
int SKILLPOINTS_SURFACE_HEIGHT = 60;
int SKILLPOINTS_TEXT_POSITION_X = 0;
...
int MANA_SURFACE_BEGIN_Y = 0;
int MANA_SURFACE_WIDTH = 5;
int MANA_SURFACE_HEIGHT = 60;
int MANA_TEXT_POSITION_X = 0;
