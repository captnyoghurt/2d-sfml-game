...
int MenuBattle::af_MenuBattleRight(Game &g)
{
	...
	if ((unsigned)std::dynamic_pointer_cast<MenuChoice>(m_menus.at(m_activeMenu))->getSelectedChoice() < std::dynamic_pointer_cast<MenuChoice>(m_menus.at(m_activeMenu))->getChoices().size())
	{
