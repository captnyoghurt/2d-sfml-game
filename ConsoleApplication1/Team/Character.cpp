...
{
	m_combatStand = g.getRealSurfaceManager().at(MAP_MAX_LAYER + Game::e_ressourcesLayer::RESSOURCES_CHARACTERS - 1).addSurface(ManageSurfaces::e_thing::SPRITE, std::shared_ptr<Surface>(new SurfaceSprite));
